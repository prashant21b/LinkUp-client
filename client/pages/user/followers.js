...
const followers= () => {
    ...
    const handleRemove= async (userId) => {
        try {
           const {data}=await axios.put(`/user-remove`,{
            _id:userId
           })
    ...
    //     try {
    //        const {data}=await axios.put('http://localhost:8000/api/user-unfollow',{
    //         _id:userId
    //        })
    ...
    return (
         <>
          <h6 className="text-center mt-5">Followers</h6>
        <div className="align-item-center w-40 mt-5" style={{width:"250px",margin:"auto"}}>
